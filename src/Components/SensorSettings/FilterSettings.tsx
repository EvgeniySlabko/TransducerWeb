...
export class FilterSettings extends React.Component<Props> {
    ...
    render() {
        return (
            <>
                <MenuItem label="Фильтр нижних частот:" children={<Checkbox defaultChecked={this.props.enabled} onChange={(c) => this.props.onFilterEnabledChanged(c.target.checked)}></Checkbox>} />
                ...
                {!this.props.enabled ? (
                    ...
                    <>
                        <MenuItem
                            children={
                                <Select defaultValue={this.props.filterType} style={{ width: 120 }} onChange={this.props.onFilterTypeChanged}>
