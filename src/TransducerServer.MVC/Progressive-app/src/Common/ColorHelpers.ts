...
export function ChangeGroupColor(groups: ChannelsGroup[], index: number) {
  groups.forEach((group) => {
    group.cellChannel.Style.color = ChangeChannelColorAccordigIndex(
      group.cellChannel.Style.color,
      group.cellChannel.Style.valueType,
      index
    );
    group.plotChannel.Style.color = ChangeChannelColorAccordigIndex(
      group.plotChannel.Style.color,
      group.plotChannel.Style.valueType,
      index
    );
    group.savingChannel.Style.color = ChangeChannelColorAccordigIndex(
      group.savingChannel.Style.color,
      group.savingChannel.Style.valueType,
      index
    );
  });
}
...
export function ChangeChannelColorAccordigIndex(
  color: string,
