...
export class ModBusSensorDataCommandEncoder
  implements ISensorDataCommandEncoder
{
...
export function CreateModBusSensorDataCommandEncoder(
  readerWriter: IReaderWriter
): ISensorDataCommandEncoder {
