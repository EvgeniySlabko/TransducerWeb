...
export class DefaultModBusCommand implements ISensorCommand {
    ...
    constructor(deviceAddress: SensorCommand, command: number, address: number, value: number) {
...
export class MultipleModBusCommand implements ISensorCommand {
    ...
    constructor(deviceAddress: number, command: SensorCommand, address: number, bytes: Uint8Array) {
        this.deviceAddress = deviceAddress;
        this.Command = command;
        this.address = address;
        this.bytes = bytes;
