...
export class MyUPlotBase {
    ...
    constructor(element: HTMLElement, parameters: PlotParameters) {
        (this.params.pointsPerSecond = parameters.pointsPerSecond), (this.params.maxScreenSize = parameters.maxScreenSize);
    ...
    protected getOptions() {
        return {
            ...
            plugins: [this.limitsPlugin(this.limits), this.wheelZoomPlugin({ factor: 0.75 }), this.labelsPlugin(this.labels)],
            mode: 1,
