  ...
  render() {
    return (
      <>
        <Space size={"small"}>
          {this.props.visibleChannels.map((c, i) => (
            <Checkbox
              ...
              defaultChecked={c[1]}
              onChange={(e) =>
                this.props.onVisibleChannelsChanged(i, e.target.checked)
              }
            >
              {c[0]}{" "}
            </Checkbox>
        ...
        <MenuItem
          label="Период измерения скорости(мс):"
          children={
            <InputNumber
        ...
        <MenuItem
          ...
          children={
            <InputNumber
              className="vertical-align"
              min={this.props.group.node.worker.DecoderParams.minAvgRatio}
              max={5000}
              step={1}
              size="small"
              style={{ height: "25px" }}
        ...
        <MenuItem
          ...
          children={
            <Checkbox
              ...
              onChange={(c) =>
                this.props.onExternalSpeedSensorChanged(c.target.checked)
              }
            />
          }
        />
        ...
        <MenuItem
          ...
          children={
            <Checkbox
              ...
              onChange={(c) =>
                this.props.onTrackMaximumChanged(c.target.checked)
              }
            />
          }
        />
        ...
        <MenuItem
          label="Инвертировать основную величину:"
          children={
            <Checkbox
        ...
        <MenuItem
          ...
          children={
            <div style={{ display: "flex", alignItems: "baseline" }}>
              <Button
                size="small"
                onClick={() => this.props.onOffsetChanged(0)}
              >
                Сбросить
              </Button>
