      ...
      <div onClick={(e) => e.stopPropagation()}>
        ...
        >
          <div className="vertical-flex">
            <MenuItem
              ...
              children={
                <Slider
                  ...
                  max={50}
                  onChange={(e) => {
                    this.props.group.cellChannel.Style.fontSize = e;
                  }}
                />
              }
            />
            ...
            <MenuItem
              label="Пределы измерений:"
              children={
                <Checkbox
                  disabled={
                    this.props.group.cellChannel.Style.limits === undefined
                  }
                  defaultChecked={
                    this.state != undefined &&
                    this.props.group.plotChannel.Style.drawLimits
                  }
